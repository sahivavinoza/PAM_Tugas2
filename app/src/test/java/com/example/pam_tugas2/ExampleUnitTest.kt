...
// Model data hasil format tampilan (Transform)
...
class NewsFeedSimulator {
    // 4. StateFlow untuk mencatat jumlah berita yang sudah dibaca
    ...
    // 1. Flow simulasi data berita baru masuk setiap 2 detik
...
class NewsFeedSimulatorTest {
    ...
    @Test
    fun testNewsFeedSimulator() = runBlocking {
